 ...
 * @Last Modified time: 2021-01-25 14:10:07
  ...
  <div class="tpl-form-create">
    <el-form label-width="80px">
      <el-table class="ws-create-form" row-key="key" ref="table" border :data="formJsonArray" @selection-change="doSelectionChange">
        ...
        <el-table-column label="标题" prop="label" align="center"></el-table-column>
        <el-table-column width="100" label="Key" prop="key" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="100" label="描述" prop="desc" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column width="100" label="类型" prop="domType" align="center"></el-table-column>
        <el-table-column width="100" label="子类型" prop="domType" align="center">
    ...
    <!-- dom配置层 -->
    <el-drawer title="From Item 配置" :visible.sync="isDrawerShow" append-to-body size="300">
